...
namespace VIAEventAssociation.Core.Domain.Services
{
    public interface IEventService
    {
        ...
        OperationResult<Unit> UpdateEventDescription(VeaEvent veaEvent, string newDescription);
        OperationResult<Unit> UpdateEventTitle(VeaEvent veaEvent, string newTitle);
        OperationResult<Unit> UpdateEventTimeRange(VeaEvent veaEvent, DateTime start, DateTime end);
